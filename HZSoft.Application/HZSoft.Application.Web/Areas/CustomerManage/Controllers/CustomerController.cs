...
namespace HZSoft.Application.Web.Areas.CustomerManage.Controllers
{
    ...
    public class CustomerController : MvcControllerBase
    {
        ...
        [HttpGet]
        public ActionResult GetListJoin()
        {
            var data = customerbll.GetListJoin();
        ...
        [HttpGet]
        public ActionResult GetFormJoin(string keyValue)
        {
            var data = customerbll.GetFormJoin(keyValue);
            return ToJsonResult(data);
        }
