    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace HZSoft.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// \r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using HZSoft.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace HZSoft.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// \r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HZSoft.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace HZSoft.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
            ...
            sb.Append("        /// <param name=\"entryList\">明细对象</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace HZSoft.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using HZSoft.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HZSoft.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Util;\r\n");
            sb.Append("using HZSoft.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
            ...
            sb.Append("        /// <param name=\"strChildEntitys\">明细对象</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        [HttpPost]\r\n");
            sb.Append("        [ValidateAntiForgeryToken]\r\n");
            sb.Append("        [AjaxOnly]\r\n");
