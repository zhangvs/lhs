...
using HZSoft.Util.WeChat.Model.Request.SendMessage;
using HZSoft.Util;
using HZSoft.Util.WeChat.Helper;

namespace HZSoft.Util.WeChat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        {
            //        description="测试新闻",
            //        picurl="http://www.hzsoft.cn/images/banner3.jpg",
            //        url="http://www.hzsoft.cn/fdms/index.html",
            //        title="新闻在线"
            //        },
            //                            new SendNews.SendItem
            //        {
